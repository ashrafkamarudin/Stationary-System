...
public class NewCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Stationary Shop");
        ...
        isMemberRadioBtn.setText("is a Member");

        checkMember.add(isNotMemberRadioBtn);
        isNotMemberRadioBtn.setText("Not a Member");
        ...
        jLabel8.setText("and phone number to begin");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (isMemberRadioBtn.isSelected()) {
            MemberCustomer mCust = new MemberCustomer(custName, custHp);
            new Shop(mCust).setVisible(true);
            return;
        }
        NonMemberCustomer nmCust = new NonMemberCustomer(custName, custHp);
